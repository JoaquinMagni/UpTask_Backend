...
router.post('/create-account', (0, express_validator_1.body)('name')
    ...
    .isLength({ min: 8 }).withMessage('El password debe tener un mínimo de 8 caractéres.'), (0, express_validator_1.body)('password_confirmation').custom((value, { req }) => {
    if (value !== req.body.password) {
        throw new Error('Los passwords deben ser iguales.');
    }
    return true;
...
router.post('/confirm-account', (0, express_validator_1.body)('token')
    .notEmpty().withMessage('El Token no puede ir vacío.'), validation_1.handleInputErrors, AuthController_1.AuthController.confirmAccount);
router.post('/login', (0, express_validator_1.body)('email')
    ...
    .notEmpty().withMessage('El password no puede ir vacío.'), validation_1.handleInputErrors, AuthController_1.AuthController.login);
...
router.post('/validate-token', (0, express_validator_1.body)('token')
    .notEmpty().withMessage('El Token no puede ir vacío.'), validation_1.handleInputErrors, AuthController_1.AuthController.validateToken);
...
router.put('/profile', auth_1.authenticate, (0, express_validator_1.body)('name')
    .notEmpty().withMessage('El nombre no puede ir vacío.'), (0, express_validator_1.body)('email')
...
router.post('/check-password', auth_1.authenticate, (0, express_validator_1.body)('password')
    .notEmpty().withMessage('El password no puede ir vacío.'), validation_1.handleInputErrors, AuthController_1.AuthController.checkPassword);
